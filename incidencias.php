...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<a href="index.html" class="title">Incidencias</a>
				<nav>
					<ul>
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
							<h1 class="major">Incidencias</h1>
							<span class="image fit"><img src="images/pic02.jpg" style="height:700px; width:500px;"/></span>
							<p></p>
							<p></p>
						</div>
					</section>
